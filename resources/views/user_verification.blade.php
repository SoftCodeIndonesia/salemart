                                                        ...
                                                        <tr>
                                                            <td style="width:100%;padding-right:0;padding-left:0">
                                                                <div align="center" style="line-height:10px"><img
                                                                        src="https://d15k2d11r6t6rl.cloudfront.net/public/users/BeeFree/beefree-ba68alhayqb/SoftCode%20Indonesia.png"
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="font-family:sans-serif">
                                                                    <div
                                                                        style="font-size:14px;mso-line-height-alt:16.8px;color:#555;line-height:1.2;font-family:Tahoma,Verdana,Segoe,sans-serif">
                                                                        <p
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="font-family:sans-serif">
                                                                    <div
                                                                        style="font-size:14px;mso-line-height-alt:16.8px;color:#555;line-height:1.2;font-family:Tahoma,Verdana,Segoe,sans-serif">
                                                                        <p style="margin:0;font-size:14px">Dear
                                                                            {{$username}}
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="font-family:sans-serif">
                                                                    <div
                                                                        style="font-size:14px;mso-line-height-alt:16.8px;color:#555;line-height:1.2;font-family:Tahoma,Verdana,Segoe,sans-serif">
                                                                        <p style="margin:0;font-size:14px">Mohon untuk
                                                                            dapat melakukan verifikasi atas registrasi
                                                                            yang dilakukan dengan memasukkan kode
                                                                            berikut pada halaman konfirmasi:</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div style="font-family:sans-serif">
                                                                    <div
                                                                        style="font-size:14px;mso-line-height-alt:16.8px;color:#555;line-height:1.2;font-family:Tahoma,Verdana,Segoe,sans-serif">
                                                                        <p style="margin:0;font-size:14px">Abaikan email
                                                                            ini apabila Anda tidak merasa melakukan
                                                                            pendaftaran akun pada sistem kami.</p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                        ...
                                                                        <td style="text-align:center">
                                                                            ...
                                                                            <table class="icons-inner"
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td
                                                                                        style="font-family:Tahoma,Verdana,Segoe,sans-serif;font-size:15px;color:#9d9d9d;vertical-align:middle;letter-spacing:undefined;text-align:center">
